...
const Gallery = () => {
  ...
  return (
    <div className="">
      ...
      <p className="text-center mt-6 text-slate-700">Discover the Ultimate Relaxation and Rejuvenation with our Signature
      Services.</p>
      <div className="mt-12 flex flex-col lg:flex-row justify-between gap-10">
        ...
        <div className="gallery-images w-full lg:w-[60%]">
          <Carousel slides={slides} onSlideChange={handleSlideChange} intervalTime={4500} />
        </div>
      </div>
    </div>
  );
